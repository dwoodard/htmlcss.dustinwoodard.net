	...
	<body id="projects">
		<div id="wrapper">
			...
			<div  id="footer">
				...
				<div class="col">
					...
					<div class="col-cnt">
						<p><strong>Email:</strong> <a href="mailto:dustin.woodard@gmail.com">dustin.woodard@gmail.com</a></p>
						<p><strong>Phone:</strong> 801-645-1949</p>
		...
		<div class="footer-bottom">
			<div class="shell">
				...
				<p class="copy">&copy; Copyright 2014<span>|</span>Dustin Woodard. </p>
			</div>
		</div>
	</div>
	<!-- end of footer -->
